...
function RoomDes3() {
  ...
  const bill = () => {
    localStorage.setItem("price",difference * 1999)
    nav("/billing");
  };
  ...
  return (
    ...
    <img src={presidentalsuit} height={300} width={600}/>
   ...
   <br/><br/>
    ...
    <br/><br/>
    <h3>Total price: {difference*1999}</h3>
